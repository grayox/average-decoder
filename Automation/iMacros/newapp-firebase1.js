...
var       app = getData(1) // "Mojo" // Short version, no spaces
  ...
  ,   byTitle = app + " by " + byWhom // Fixes Twitter error: "App name already in use."
