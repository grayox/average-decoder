...
function receiveInventory(ob){//var user=(Session.getActiveUser().getEmail())?Session.getActiveUser().getEmail():null;if(user){ob.yEmail=user}
    LibraryjsUtil.dbParse("post","charlie","inventory",ob);return}//return Logger.log(JSON.stringify(ob))} // Reference: https://developers.google.com/apps-script/guides/html-service-communication#forms
function receivePropAnal(ob){ob.docUrl=DriveApp.createFile(ob.myFile).getUrl();delete ob.myFile;ob.agent=(Session.getActiveUser().getEmail())?Session.getActiveUser().getEmail():null;
    LibraryjsUtil.dbParse("post","delta","propAnal",ob);return}//return Logger.log(JSON.stringify(ob))} // Goes in Code.gs // Reference: https://developers.google.com/apps-script/guides/html-service-communication#forms
...
<!DOCTYPE html><html style="text-align:center;font-family:arial;font-size:100%;color:#777777;"><head><meta charset="utf-8"/></head><body>
    <form id="myForm" style="xtext-align:center;xbackground:grey;padding:6px;xborder:2px solid #DDDDDD;xborder-radius:8px;"><!--References: https://developers.google.com/apps-script/guides/html-service-communication#forms https://developers.google.com/apps-script/guides/html-service-communication#user_objects-->
        <input type="text"  style="xcolor:#008800;xheight:100px;font-size: 90%;padding:10px 20px;xborder:1px solid #00DD00;border-radius:999px;" size="40" id="address" name="address" placeholder="Address" title="Subject address. Example: 104 Desert Broom Court, New Brunswick, NJ 08901" >
        <input type="text"  style="xcolor:#008800;xheight:100px;font-size: 90%;padding:10px 20px;xborder:1px solid #00DD00;border-radius:999px;" size="5"  id="arv"     name="arv"     placeholder="ARV"     title="After repair value. Example: 100000"                                       >
        <input type="text"  style="xcolor:#008800;xheight:100px;font-size: 90%;padding:10px 20px;xborder:1px solid #00DD00;border-radius:999px;" size="5"  id="repairs" name="repairs" placeholder="Repairs" title="Repairs cost estimate. Example: 30000"                                     >
        <input type="text"  style="xcolor:#008800;xheight:100px;font-size: 90%;padding:10px 20px;xborder:1px solid #00DD00;border-radius:999px;" size="5"  id="title"   name="title"   placeholder="Title"   title="Cost to clear title. Example: 10000"                                       >
	...
	<br><input type="button" value="Submit property analysis" onclick="google.script.run.withSuccessHandler(updateUrl).receivePropAnal(this.parentNode);this.parentNode.reset()" style="background:#150035;font-size:100%;color:white;font-weight:bold;border-radius:999px;padding:10px 20px;display:inline-block;width:850px;" title=""> <!-- Reference: http://stackoverflow.com/questions/5462251/button-width-in-css3 -->
...
<body>
  <div><img src="https://lh6.googleusercontent.com/-kt3YNu469Qk/U8H3u6p5B9I/AAAAAAAAMIQ/OpGzqKFq37Q/s800/logo.png"></div>
  <div style="width:100%;margin:0 auto;xtext-align:left">
    <form id="referral" style="xbackground:grey;padding:6px;xborder:2px solid #DDDDDD;border-radius:8px;"><!--References: https://developers.google.com/apps-script/guides/html-service-communication#forms https://developers.google.com/apps-script/guides/html-service-communication#user_objects-->
        <input type="text"  style="color:#6d9eeb;xheight:100px;font-size: 90%;padding:10px 20px;xborder:1px solid #00DD00;border-radius:999px;" size="66" id="address" name="address" placeholder="Address" title="The address of the property you want to sell. Example: 104 Desert Broom Court, New Brunswick, NJ 08901" >
        <input type="text"  style="color:#6d9eeb;xheight:100px;font-size: 90%;padding:10px 20px;xborder:1px solid #00DD00;border-radius:999px;" size="26" id="price"   name="price"   placeholder="Price"   title="Your absolute rock bottom price. Example: 100000"       >
    <br><input type="text"  style="color:#6d9eeb;xheight:100px;font-size: 90%;padding:10px 20px;xborder:1px solid #00DD00;border-radius:999px;" size="26" id="name"    name="name"    placeholder="Name"    title="Your full first and last names. Example: John Doe, III" >
        <input type="text"  style="color:#6d9eeb;xheight:100px;font-size: 90%;padding:10px 20px;xborder:1px solid #00DD00;border-radius:999px;" size="26" id="email"   name="email"   placeholder="Email"   title="Your email address. Example: johndoe@example.com"       >
        <input type="text"  style="color:#6d9eeb;xheight:100px;font-size: 90%;padding:10px 20px;xborder:1px solid #00DD00;border-radius:999px;" size="26" id="phone"   name="phone"   placeholder="Phone"   title="Best phone number to reach you. Example: 555-555-1212"  > <!--<br><input type="text"   style="color:#888888;xheight:100px;font-size:100%;padding:5px;xborder:1px solid #00DD00;border-radius:5px;" size="35" id="phoneEve" name="phoneEve" placeholder="2nd phone" title="Alternate phone number to reach customer. Example: 555-555-1212" > // Reference: http://stackoverflow.com/questions/1994406/set-image-as-submit-button // Works on jsfiddl.net but not GAS -->
    <br><input type="button" value="Get instant cash offer" onclick="myFunction();" style="background:#6d9eeb;font-size:100%;color:white;font-weight:bold;border-radius:999px;padding:10px 20px;display:inline-block;width:725px;" title="Get offer now!"> <!-- Reference: http://stackoverflow.com/questions/5462251/button-width-in-css3 -->
	</form></div><div style="font-size:75%">By pressing the above button, you affirm you have an equitable interest in the property and have the legal authority to sell it to us.</div>
<script>
