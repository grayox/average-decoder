...
function avmReportServeData(addy){//addy=addy||"3255 Whitehall Dr, Dallas, TX 75229";//function test(){var out=JSON.stringify(avmReportServeData("5115 Longfellow Street, Los Angeles, CA, 90042"));Logger.log(out);print(out)}//Logger.log(addy);//print(JSON.stringify(LibraryjsAvm.avmJson({"source":{"name":"manual","data":addy}/*,"market":{"city":"Pheonix","state":"AZ"}*/})));
      var R=0.5,S=1,out={},r=LibraryjsAvm.avmJson({"source":{"name":"manual","data":decodeURI(addy)}/*,"market":{"city":"Pheonix","state":"AZ"}*/})//
   ...
   */ , hm = r.avm.dataset.homeSnap   .estimate
	  ...
	  ; out.options={title:"Value estimates for "+r.address.full/*5115 Longfellow St, Los Angeles, CA 90042"*/,isStacked:true,series:{0:{"color":"transparent"},1:{"color":"#428bca"},2:{"color":"#428bca"}},intervals:{"lineWidth":1,"barWidth":0.7/*0.618="Golden Ratio"*/}}
      ...
      , out.dataTable = [ [ "Source"     , "Estimate"    , "Low range"                                                         , "High range"                                                        ]
                     ...
                     // , [ "Trulia"     , 509000        , 509000-110491                                                       , 509000+110491                                                       ] //,  "color : #006cff"  ] // If no range, use populastion stdDev
                        , [ "Trulia"     , tm            , tl                                                                  , th                                                                  ] //,  "color : #006cff"  ] // If no range, use populastion stdDev
                     // , [ "DataQuick"  , 511356        , 396149                                                              , 626562                                                              ] //,  "color : #0044ff"  ]
                        , [ "DataQuick"  , dm            , dl                                                                  , dh                                                                  ] //,  "color : #0044ff"  ]
                     // , [ "SmartZip"   , 326200        , 300104                                                              , 352296                                                              ] //,  "color : #006cff"  ]
                        , [ "SmartZip"   , sm            , sl                                                                  , sh                                                                  ] //,  "color : #006cff"  ]
                     // , [ "Eppraisal"  , 358687        , 304884                                                              , 412490                                                              ] //,  "color : #0044ff"  ]
                        , [ "Eppraisal"  , em            , el                                                                  , eh                                                                  ] //,  "color : #0044ff"  ]
                     // , [ "RealEstate" , 347631        , 347631-110491                                                       , 347631+110491                                                       ]]//,  "color : #006cff"  ] // If no range, use populastion stdDev
                        , [ "RealEstate" , rm            , rl                                                                  , rh                                                                  ]]//,  "color : #006cff"  ] // If no range, use populastion stdDev
	  , out.link = r.link;
	return out}
...
<body><div style="width:65%;margin:auto;text-align:center">
	...
	<br><input type="button" class="btn btn-block btn-primary" xclass="blue" value="Get link for free estimates report" onclick="myFunction()"> <!-- Reference: http://stackoverflow.com/questions/5462251/button-width-in-css3 -->
